...
// TransferTxResult contais the result of the transfer transaction
...
// It creates a transfer record, add account entries, and update account's ba;nace within a single database transaction
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParam) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		// TNN-TODO: update account's balance
